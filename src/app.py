...
activities = {
    ...
    "Track and Field": {
        "description": "Training for sprinting, distance, jumps, and throws; meet participation",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 40,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media; prepare for art shows",
    ...
    "Science Club": {
        "description": "Hands-on experiments, STEM projects, and science fair preparation",
